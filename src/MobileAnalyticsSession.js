 ...
 */
export default class MobileAnalyticsSession {
    ...
    constructor(options) {
        ...
        this.id = this.options.sessionId || Util.GUID();
        ...
        this.StorageKeys = {
            'SESSION_ID': StorageKeys.SESSION_ID + this.id,
            'SESSION_EXPIRATION': StorageKeys.SESSION_EXPIRATION + this.id,
            'SESSION_START_TIMESTAMP': StorageKeys.SESSION_START_TIMESTAMP + this.id
        };
